...
for root_dir,sub_dir,files in os.walk(r"/Users/pingguo/Documents/签证"):
    for file in files:
...
for city in cities:
    city_data = c[c[0] == city].sort_values(by='Formatted_Date')
    plt.plot(city_data['Formatted_Date'], city_data[2], label=city, marker='o', linestyle='-')
